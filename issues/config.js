...
const CONFIG = {
  ...
  issueTypes: {
    bug: {
      ...
      githubLabel: "bug",
      fields: [
        { id: "title",       label: "Summary",                    type: "text",     required: true,  placeholder: "Brief description of the bug",                                    weight: 15, detailBonus: { min: 20, ideal: 60, max: 5 } },
        { id: "gameversion", label: "Game Version",               type: "text",     required: true, placeholder: "e.g. Build 42.0.5",                                                weight: 5, detailBonus: { min: 5, ideal: 15, max: 3 } },
        ...
        { id: "repro",       label: "Steps to Reproduce",         type: "textarea", required: true,  placeholder: "1. Go to...\n2. Click on...\n3. Observe...",                     weight: 20, detailBonus: { min: 50, ideal: 200, max: 10 } },
        { id: "expected",    label: "Expected Behavior",          type: "textarea", required: false,  placeholder: "What should have happened?",                                       weight: 15, detailBonus: { min: 30, ideal: 100, max: 5 } },
        ...
        { id: "platform",    label: "Platform",                   type: "select",   required: false, options: ["Windows 10", "Windows 11", "Linux", "macOS", "Steam Deck"],          weight: 5 },
